...
import echarts, { ECOption } from '@/components/crane-echarts/echarts.ts';

export interface CraneEchartsProps {
  option: ECOption;
...
const props = withDefaults(defineProps<CraneEchartsProps>(), {
  theme: null,
  loading: false,
  onMouseover: () => {},
  onMouseout: () => {}
